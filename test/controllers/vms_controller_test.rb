...
class VmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vm" do
    assert_difference('Vm.count') do
      post vms_url, params: { vm: { cpu_count: @vm.cpu_count, memory: @vm.memory, name: @vm.name, state: @vm.state } }
    end
  ...
  test "should update vm" do
    patch vm_url(@vm), params: { vm: { cpu_count: @vm.cpu_count, memory: @vm.memory, name: @vm.name, state: @vm.state } }
